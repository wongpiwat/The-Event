...
<body>
  ...
  <div id="gstatus" style="display:none;margin-bottom:15px;">
    ...
    <button id="gsignupbtn"  type="button" name="SignUp" onclick="document.getElementById('deleteAccount').style.display='block'" style="width: 60%; height: 7%;float: right;background-color: #4CAF50;
color: white;
padding: 10px 18px;
margin: 8px 0;
border: none;
