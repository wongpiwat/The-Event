...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 05, 2018 at 08:02 AM
...
INSERT INTO `event` (`ID_Event`, `username`, `eventName`, `location`, `date`, `time`, `size`, `category`, `type`, `price`, `details`, `teaserVDO`, `precondition`, `postcondition`, `organizerName`, `contactName`, `email`, `phone`) VALUES
