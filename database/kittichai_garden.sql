...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 05, 2018 at 02:35 PM
...
--
-- Dumping data for table `image_event`
--

INSERT INTO `image_event` (`idEvent`, `image`) VALUES
(11548, 'https://p-u.popcdn.net/events/posters/000/003/049/medium/Starto!-Poster-SQ01.jpg?1519722456'),
(12378, 'https://p-u.popcdn.net/events/posters/000/003/020/medium/Eventposter_425x610.png?1519115403'),
(14537, 'https://p-u.popcdn.net/events/posters/000/003/039/medium/Poster_2048X2048_March.jpg?1519293937'),
(14796, 'https://p-u.popcdn.net/events/posters/000/002/868/medium/Poster_1.jpg?1515989221');
...
ALTER TABLE `image_event`
  ADD PRIMARY KEY (`idEvent`,`image`) USING BTREE;
...
ALTER TABLE `attendents`
  ...
  ADD CONSTRAINT `attendents_ibfk_2` FOREIGN KEY (`ID_Event`) REFERENCES `event` (`idEvent`);
COMMIT;
