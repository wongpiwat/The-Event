...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 12, 2018 at 09:55 PM
...
('adminSun', '1234', '-', '-', '-', '-', '2018-03-14', 'male', '-', '-', 'admin', '-', 'Activate'),
('boylnwza007', 'boy', 'tanya.pa@ku.th', 'tanya', 'panicha', '1481814444568', '2539-01-09', 'male', 'Bangkok', '0854549870', 'user', 'upload-files/files/profile/boylnwza007theToys.jpg', 'Activate'),
('cher', 'cher', 'cherpang@gmail.com', 'Cherpang', 'BNK', '01548267894748', '2002-10-14', 'male', 'ม.เกษตร', '0812345678', 'admin', 'upload-files/files/profile/cherIMG_2122.jpg', 'Activate'),
('kanokpon.t', '1234', 'mondayt21@gmail.com', 'กนกพล', 'โทนะบุตร', '1102111541249', '1997-04-21', 'male', '48/333 ม4 บึงกุ่ม คลองกุ่ม กทม 10240 ', '0878421498', 'user', 'upload-files/files/profile/kanokpon.tCats-1-630x671.jpg', 'Activate'),
('mew', '@mewmew', 'mew@gmail.com', 'นิษฐา', 'จิรยั่งยืน', '4571245678456', '1995-08-12', 'male', 'Bangkok', '0815224434', 'admin', 'upload-files/files/profile/mew1377853039_1380685977.jpg', 'Activate'),
('mondayt21', 'password', 'mondayt212@gmail.com', 'วัชระ', 'โชตะนุรา', '1102700730568', '1994-09-28', 'male', '77/124  บางกะปิ คลองจั่น กทม', '0845454797', 'user', 'upload-files/files/profile/mondayt21pic2.jpg', 'unActivate'),
('poom', 'poom', 'wonpiwat.n@ku.th', 'wonpiwat', 'na', '1103300189111', '2018-03-16', 'male', 'Kasetsart University', '0812345678', 'user', 'upload-files/files/profile/poomCats-1-630x671.jpg', 'Activate'),
('sunny', '@Sun1342', 'vasupol.ch@ku.th', 'Kittichai', 'Ching', '1234574815464', '1999-05-22', 'male', 'Bangkok', '082445678', 'user', 'upload-files/files/profile/sunny51084.jpg', 'Activate');
...
('boylnwza007', '2018-03-13', '03:00:13', 0, 'Sign in'),
('boylnwza007', '2018-03-13', '03:03:25', 0, 'Create event กิจกรรมปั่นจักรยาน NAKHON BIKE NIGHT'),
('boylnwza007', '2018-03-13', '03:04:28', 0, 'Edit account adminSun'),
('boylnwza007', '2018-03-13', '03:04:58', 0, 'Edit account adminSun'),
('boylnwza007', '2018-03-13', '03:05:04', 0, 'Edit account boylnwza007'),
('boylnwza007', '2018-03-13', '03:12:44', 0, 'Create event ROV Valor Tournament'),
('boylnwza007', '2018-03-13', '03:14:32', 0, 'Create event WisePass Bangkok Official Launch'),
('boylnwza007', '2018-03-13', '03:15:55', 0, 'Create event THAILAND FOODIES FESTIVAL'),
('boylnwza007', '2018-03-13', '03:17:44', 0, 'Create event The Bangkok International Taste Experience (BITE)'),
('boylnwza007', '2018-03-13', '03:19:38', 0, 'Create event DND WATER CIRCUS'),
('boylnwza007', '2018-03-13', '03:21:10', 0, 'Create event Retrospect Heart of the Panther หัวใจเสือดำ'),
('boylnwza007', '2018-03-13', '03:25:40', 0, 'Sign out'),
('boylnwza007', '2018-03-13', '03:44:59', 0, 'Sign in'),
('boylnwza007', '2018-03-13', '03:46:28', 0, 'Create webboard อยากจับมือ เฌอปรางต้องทำยังไงครับ'),
('boylnwza007', '2018-03-13', '03:47:46', 0, 'Sign out'),
...
('mondayt21', '2018-03-13', '01:24:27', 0, 'Sign in'),
('mondayt21', '2018-03-13', '01:26:50', 0, 'Sign out'),
('poom', '2018-03-13', '02:48:36', 0, 'Sign in'),
('poom', '2018-03-13', '02:50:03', 0, 'Create event https://www.youtube.com/watch?v=evGFaS6epT8'),
('poom', '2018-03-13', '02:52:15', 0, 'Create event รวมใจรัก ปั่นเพื่อพ่อ Chonburi Cycling '),
('poom', '2018-03-13', '02:53:42', 0, 'Create event RUN FOR LIFE 2'),
('poom', '2018-03-13', '02:55:54', 0, 'Create event RUN FOR LIFE 2'),
('poom', '2018-03-13', '02:56:11', 0, 'Sign out'),
('sunny', '2018-03-13', '01:21:35', 0, 'Sign in'),
('sunny', '2018-03-13', '01:24:21', 0, 'Sign out'),
('sunny', '2018-03-13', '01:39:02', 0, 'Sign in'),
('sunny', '2018-03-13', '01:51:19', 0, 'Create event Basic Scan N Cut'),
('sunny', '2018-03-13', '01:52:54', 0, 'Create event Trick to Translate เคล็ด (ไม่) ลับ ฉบับนักแปล โดย ปุ๋ย มณฑารัตน์ ทรงเผ่า'),
('sunny', '2018-03-13', '01:55:15', 0, 'Create event Trick to Translate เคล็ด (ไม่) ลับ ฉบับนักแปล โดย ปุ๋ย มณฑารัตน์ ทรงเผ่า'),
('sunny', '2018-03-13', '01:57:48', 0, 'Create event YOGA WORKSHOP by AMIT from INDIA'),
('sunny', '2018-03-13', '02:01:36', 0, 'Create event Basic Laser cut : คลาสเรียนการใช้งานเลเซอร์คัทพื้นฐาน'),
('sunny', '2018-03-13', '02:03:46', 0, 'Create event KILORUN 2018'),
('sunny', '2018-03-13', '02:06:16', 0, 'Create event Detox workshop by Kru Bud [ENGLISH]'),
('sunny', '2018-03-13', '02:06:58', 0, 'Sign out'),
('sunny', '2018-03-13', '02:32:37', 0, 'Sign in'),
('sunny', '2018-03-13', '02:34:03', 0, 'Create event Thailand Mobile Expo 2018'),
('sunny', '2018-03-13', '02:36:58', 0, 'Create event Sustainable Energy Technology Asia 2018'),
('sunny', '2018-03-13', '02:38:05', 0, 'Create event Commart Connect 2018 '),
('sunny', '2018-03-13', '02:39:19', 0, 'Create event Thailand Autopart & Accessories 2018 (TAPA)'),
('sunny', '2018-03-13', '02:41:43', 0, 'Create event งานท่องไทย ท่องโลกครั้งที่ 19 '),
('sunny', '2018-03-13', '02:44:11', 0, 'Create event งานไทยเที่ยวไทย ครั้งที่ 46'),
('sunny', '2018-03-13', '02:44:41', 0, 'Sign out'),
('sunny', '2018-03-13', '03:36:44', 0, 'Sign in'),
('sunny', '2018-03-13', '03:36:54', 0, 'Sign out'),
('sunny', '2018-03-13', '03:46:56', 0, 'Sign in');
...
(1, 'boylnwza007', 3, '2018-03-13', '03:23:17', 'Uncomfirm'),
(1, 'sunny', 2, '2018-03-13', '03:36:50', 'Uncomfirm');
...
(1, 'sunny', 'ซือบัตรจับมือครับ จับได้ประมาณ 5 วิ -///-', '2018-03-13', '03:47:34');
...
(1, 1, 'boylnwza007', 'อยากจับมือ เฌอปรางต้องทำยังไงครับ', ' ต้องทำบุญยังไงครับถึงจะได้ จับมือเค้า บอกผมด้วยครับบบ!!! >.<', '2018-03-13', '03:46:28', 3, 1);
