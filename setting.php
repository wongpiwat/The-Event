...
<body>
    ...
    <div class="container" >
        <div class="row">
            <nav class="col-sm-3">
            <ul class="nav nav-pills nav-stacked" data-spy="affix" data-offset-top="205" style="width:200px;margin-left:-25%;">
                ...
                document.getElementById('mSystemLogs').className='';
                document.getElementById('mActivityLogs').className='';
                "><span class="glyphicon glyphicon-user" ></span> Manage Users</a></li>
                ...
                document.getElementById('mSystemLogs').className='';
                document.getElementById('mActivityLogs').className='';
                "><span class="glyphicon glyphicon-th-large" ></span> Manage Events</a></li>
