...
**********************************************************/
		...
		.svg-cash-hand { fill: #FFCA65; }
		.svg-cash-thumb { stroke: #FBAD3E; fill: none; }
		.svg-cash-money { fill: #34b154; }
		.svg-cash-money-inner { fill: #fff; opacity: .4; }
		.svg-cash-shirt-inner { fill: #def; }
        .svg-cash-shirt-outer { fill: #07b; }
		...
		.svg-click-border { fill: #FF8000; }
		.svg-click-logo { fill: #FF8000; }
		.svg-click-letter { fill: #FF8000; }
		.svg-click-letter-center { fill: #808080; }
...
<div class="main">
  ...
  <div class='payments'>
    ...
    <div class='button con'>
      <li><a href="#"  onclick="document.getElementById('credit').style.display='block'" ><span class="glyphicon glyphicon-credit-card" ></span> Credit Card</a></li>
    ...
    <div class='button active'>
    	<li><a href="#"  onclick="successTell('');" ><span class="glyphicon glyphicon-usd" ></span> Cash(Collect on delivery)</a></li>
...
<div id="credit" class="credit" >
  <form class="credit-content animate con"  id="creditForm" method="GET" style="height:450px;" >
  	<div class="panel-heading display-table" >
  	<h3 class="panel-title display-td" >Payment Details</h3>
  	<br>
  	<br>                         
	</div>
	<label for="cardNumber">CARD NUMBER</label><img style="padding-top: 10px " class="img-responsive pull-right" src="http://i76.imgup.net/accepted_c22e0.png">
	<div class="input-group">
		<input maxlength="16" type="tel"class="form-control"name="cardNumber"placeholder="Valid Card Number" autocomplete="cc-number" required autofocus />
		<span class="input-group-addon"><i class="fa fa-credit-card"></i></span>
	</div>
	<br>
	<div class="form-group">
		<label for="cardExpiry"><span class="hidden-xs">EXPIRATION</span><span class="visible-xs-inline">EXP</span> DATE</label>
		<input style="width:80px;" maxlength="5" type="tel" class="form-control" name="cardExpiry"placeholder="MM / YY"autocomplete="cc-exp" required />
	</div>
	<br>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<input type="hidden" value="" name="idEvent" id="sEvent">
	<button  style="width: 20%; float: right; "  class="btn btn-success btn-lg btn-block" type="button" id="SubmitB" onclick="successTell('')" >submit</button>
