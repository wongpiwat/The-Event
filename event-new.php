      ...
      if ( sectionOffset <= scrollbarLocation ) {
        ...
        function setElement(array){
            ...
            if(array[11] != ""){
                ...
                //document.getElementById("embedE").src =array[17];
                //alert("Hello");
            }
        }

        function setDetailEvent(array){
            if(array[10].length >= 750){
            document.getElementById("deE").innerHTML = array[10].substr(0,584);
            document.getElementById("readMoreE").innerHTML = array[10].substr(584,array[10].length) ;
            }else{
                var half = array[10].length / 2;
                document.getElementById("deE").innerHTML = array[10].substr(0,half);
                document.getElementById("readMoreE").innerHTML = array[10].substr(half,array[10].length) ;
            }
            console.log(array[10].substr(0,550));
        ...
        function buy(){
            ...
            var idEv = arrayE['0'];
            console.log(idEv);
            $.post("src/indexPHP.php",{attendant:true,idEvent:idEv,username:username,amount:numTicket},
            function(data){
                console.log(data);
            });
